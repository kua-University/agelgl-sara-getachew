...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    Context context;
    String removeUrl = "http://192.168.137.51/agelgl-restaurant/agelgl-restaurant/public/api/users/cart/remove";
    String addUrl = "http://192.168.137.51/agelgl-restaurant/agelgl-restaurant/public/api/users/cart/add";
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        sharedPreferences = context.getSharedPreferences("agelgl", MODE_PRIVATE);
