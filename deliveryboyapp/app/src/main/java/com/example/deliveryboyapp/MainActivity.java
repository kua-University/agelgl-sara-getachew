...
public class MainActivity extends AppCompatActivity {
    ...
    String apiUrl = "http://192.168.137.51/food-delivery-application/fooddeliveryapp/public/api/users/delivery?email=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSuccess.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                markOrderStatus("http://192.168.137.165/agelgl-restaurant/agelgl-restaurant/public/api/users/delivery/success?order_id=" + order_id,
                        "success");
            }
        });
        ...
        buttonFailed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                markOrderStatus("http://192.168.137.165/agelgl-restaurant/agelgl-restaurant/public/api/users/delivery/failed?order_id=" + order_id,
                        "failed");
            }
        });
